  ...
  \*********************************/
        ...
        function(module, exports, __webpack_require__) {
            ...
            Symbol.prototype.getAttr = function(attName) {
                ...
                if (origin && "bottom" !== origin || !isOnSameColumn || !isUnder)
                                ...
                                if (origin && "right" !== origin || !isOnSameColumn || !isUnder)
                                    if (origin && "bottom" !== origin || !isLeft)
                                        if (origin && "bottom" !== origin || !isRight)
                                            if (origin && "right" === origin && isLeft) line = drawLine(this.chart, right, [{
                                                ...
                                                x: symbolTop.x,
                                                y: symbolTop.y
                                            }], text), this.rightStart = !0, symbol.topEnd = !0, maxX = right.x + lineLength / 2;
                                            else if (origin && "right" === origin && isRight) line = drawLine(this.chart, right, [{
                    x: symbolTop.x,
                    y: right.y
                }, {
                    x: symbolTop.x,
                ...
                else if (origin && "bottom" === origin && isOnSameColumn && isUpper) line = drawLine(this.chart, bottom, [{
                    x: bottom.x,
                    ...
                    x: symbolTop.x,
                    y: symbolTop.y
                }], text), this.bottomStart = !0, symbol.topEnd = !0, maxX = bottom.x + lineLength / 2;
                    ...
                    x: symbolTop.x,
                    y: symbolTop.y
                }], text), this.bottomStart = !0, symbol.topEnd = !0, maxX = bottom.x + (bottom.x - symbolTop.x) / 2;
                else line = this.leftEnd && isUpper ? drawLine(this.chart, bottom, [{
                    x: bottom.x,
                    y: bottom.y + lineLength / 2
                }, {
                    x: bottom.x + (bottom.x - symbolTop.x) / 2,
                    ...
                    this.leftStart = !0, symbol.rightEnd = !0, maxX = symbolRight.x;
                ...
                if (line) {
                    for (var l = 0, llen = this.chart.lines.length; l < llen; l++)
                        for (var len, otherLine = this.chart.lines[l], ePath = otherLine.attr("path"), lPath = line.attr("path"), iP = 0, lenP = ePath.length - 1; iP < lenP; iP++) {
                            var newPath = [];
        ...
        function(module, exports, __webpack_require__) {
            function parse(input) {
                ...
                for (var chart = {
                    ...
                    }, lines = [], prevBreak = 0, i0 = 1, i0len = input.length; i0 < i0len; i0++)
                    if ("\n" === input[i0] && "\\" !== input[i0 - 1]) {
                ...
                for (; lines.length > 0;) {
                    ...
                    if (line.indexOf("=>") >= 0) {
                        ...
                        for (var flowSymbols = line.split("->"), i = 0, lenS = flowSymbols.length; i < lenS; i++) {
